...
async function main(): Promise<void> {
  ...
  try {
    ...
    console.log(
      `  Mean: ${originalStats.mean.toFixed(3)}, Variance: ${originalStats.variance.toFixed(3)}\n`
    );
    ...
    console.log(
      `  Min: ${idealLowPassStats.min.toFixed(3)}, Max: ${idealLowPassStats.max.toFixed(3)}`
    );
    console.log(
      `  Mean: ${idealLowPassStats.mean.toFixed(3)}, Variance: ${idealLowPassStats.variance.toFixed(3)}`
    );

    const idealLowPassDiff = computeDifference(originalImage, idealLowPassResult);
    console.log(
      `Difference from original: max=${idealLowPassDiff.maxDiff.toFixed(3)}, mean=${idealLowPassDiff.meanDiff.toFixed(3)}`
    );
    ...
    console.log(`Filtered image stats:`);
    console.log(
      `  Min: ${gaussianLowPassStats.min.toFixed(3)}, Max: ${gaussianLowPassStats.max.toFixed(3)}`
    );
    console.log(
      `  Mean: ${gaussianLowPassStats.mean.toFixed(3)}, Variance: ${gaussianLowPassStats.variance.toFixed(3)}`
    );

    const gaussianLowPassDiff = computeDifference(originalImage, gaussianLowPassResult);
    console.log(
      `Difference from original: max=${gaussianLowPassDiff.maxDiff.toFixed(3)}, mean=${gaussianLowPassDiff.meanDiff.toFixed(3)}`
    );
    ...
    console.log(`Filtered image stats:`);
    console.log(
      `  Min: ${idealHighPassStats.min.toFixed(3)}, Max: ${idealHighPassStats.max.toFixed(3)}`
    );
    console.log(
      `  Mean: ${idealHighPassStats.mean.toFixed(3)}, Variance: ${idealHighPassStats.variance.toFixed(3)}`
    );
    ...
    console.log(`Filtered image stats:`);
    console.log(
      `  Min: ${gaussianHighPassStats.min.toFixed(3)}, Max: ${gaussianHighPassStats.max.toFixed(3)}`
    );
    console.log(
      `  Mean: ${gaussianHighPassStats.mean.toFixed(3)}, Variance: ${gaussianHighPassStats.variance.toFixed(3)}`
    );
    ...
    console.log('---------------------|-----------------|------------------');
    console.log(
      `Ideal Low-Pass       | ${((idealLowPassStats.variance / originalStats.variance) * 100).toFixed(1)}%          | Blur/Smooth`
    );
    console.log(
      `Gaussian Low-Pass    | ${((gaussianLowPassStats.variance / originalStats.variance) * 100).toFixed(1)}%          | Smooth Blur`
    );
    console.log(
      `Ideal High-Pass      | ${((idealHighPassStats.variance / originalStats.variance) * 100).toFixed(1)}%          | Edge Detection`
    );
    console.log(
      `Gaussian High-Pass   | ${((gaussianHighPassStats.variance / originalStats.variance) * 100).toFixed(1)}%          | Smooth Edges`
    );
